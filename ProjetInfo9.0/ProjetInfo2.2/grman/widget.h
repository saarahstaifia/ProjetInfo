...
class Widget
{
    ...
    public :
        ...
        Widget(double x, double y, double w, double h, int border_color=GRISSOMBRE) :
            m_frame(x, y, w, h), m_border_color(border_color){}
        Widget() = default;
        ...
        void set_border_color(int border_color) {m_border_color=border_color;}
...
class WidgetBox : public Widget
{
    ...
    public :
        ...
        WidgetBox(float CoefCroissance=0, int mark=0,int reverse_mark=0,int Num_Connexe=0):
            m_CoefCroissance(CoefCroissance), m_mark(mark),m_reverse_mark(reverse_mark),m_Num_Connexe(Num_Connexe) {}
        ...
        bool get_value() { return m_value; }
        void set_value(bool value) { m_value = value; }
        float get_Coef() { return m_CoefCroissance; }
        float set_Coef(float CoefCroissance) { m_CoefCroissance = CoefCroissance; }
        int get_mark() { return m_mark; }
        void set_mark(int mark) { m_mark = mark; }
        int get_reverse_mark() { return m_reverse_mark; }
        void set_reverse_mark(int reverse_mark) { m_reverse_mark = reverse_mark; }
        int get_Num_Connexe() { return m_Num_Connexe; }
        void set_Num_Connexe(int Num_Connexe) { m_Num_Connexe = Num_Connexe; }
};
...
class WidgetEdge : public Widget
{
    ...
    public :
                WidgetEdge(float thickness=2):
                    m_thickness(thickness) {}



        float get_thickness() { return m_thickness; }
        float set_thickness(float thickness) { m_thickness = thickness; }
