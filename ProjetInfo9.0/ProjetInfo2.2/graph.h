...
// ,m_id(id),m_val(val),m_x(x),m_y(y),m_FileName(FileName)
                // , int id=0, float val=0, int x=0, int y=0, std::string FileName=0)
...
class GraphInterface
{
    ...
    private :
        ...
        grman::WidgetCheckBox m_checkbox2;
        ...
        grman::WidgetText m_text6;
        grman::WidgetText m_text5;
        grman::WidgetText m_text7;

        ///Images
        grman::WidgetImage m_img_save;
        grman::WidgetImage m_img_save2;
        grman::WidgetImage m_img_save3;
        grman::WidgetImage m_img_save4;
        grman::WidgetImage m_img_save5;
        grman::WidgetImage m_img_save6;
        grman::WidgetImage m_img_save7;

        grman::WidgetImage m_img_fond;
...
class Graph
{
    private :
        ...
        std::map<int, Edge> m_reverse_edges;
    ...
    public:
        ...
        ///AJOUT d'un nouveau sommet au vecteur
        ...
        ///ajout sommet
        void add_vertex(std::string animal);
        ///ajout arrete
        void add_edge(int from, int to);
        ///delete
        void effacer();
        ///tout ce qui bouge à l'écran (colors/curseurs)
        void animations(int * currentgraph,BITMAP*bmp,BITMAP* animal1,BITMAP* animal2,BITMAP* animal3,BITMAP* animal4);
        ///not moveable
        void BoxFix();
        ///dynamique
        ...
        void FindComposanteFortementConnexe();
        void BFS(int NumS);
        void BFS_inverse(int NumS);


        int Menu(BITMAP*bmp,BITMAP*menu,BITMAP*cadre,BITMAP*cadre2,BITMAP*regle,BITMAP*cadre3);
        void reset();
